...
{
    Route route;
    route.addCoordinate({-90.0, -180.0, 0});
    route.addCoordinate({0, 0, 0});
    route.addCoordinate({90.0, 180.0, 0});
...
{
    Route route;
    route.addCoordinate({38.5, -120.2, 0});
    route.addCoordinate({40.7, -120.95, 0});
    route.addCoordinate({43.252, -126.453, 0});
