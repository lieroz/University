...
//	std::cout << open_hash << std::endl;
	...
	std::cout << avl_tree.search(5) << std::endl;
	std::cout << avl_tree.get_cmp_count() << std::endl;

	std::cout << naive_tree.search(5) << std::endl;
	std::cout << naive_tree.get_cmp_count() << std::endl;

	std::cout << closed_hash.search(5) << std::endl;
	std::cout << closed_hash.get_cmp_count() << std::endl;

	std::cout << open_hash.search(5) << std::endl;
	std::cout << open_hash.get_cmp_count() << std::endl;
