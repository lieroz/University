	...
	while (true) {
		...
		switch (action_choice) {
			...
			case 1:
				...
				fprintf(stdout, "XML_Suppliers.xml { 1 }\n");
				fprintf(stdout, "XML_Products.xml { 2 }\n");
				fprintf(stdout, "XML_Shipments.xml { 3 }\n\n");
				...
				switch (action_choice) {
					...
					case 1:
						AddToFile("XML_Suppliers.xml", AddSupplier);
						break;
			...
			case 2:
				...
				switch (action_choice) {
					...
					case 1:
						RemoveFromFile("XML_Suppliers.xml", "SupplierID", id, RemoveSupplier);
						break;

					case 2:
						RemoveFromFile("XML_Products.xml", "ProductID", id, RemoveProduct);
						break;

					case 3:
						RemoveFromFile("XML_Shipments.xml", "ShipmentID", id, RemoveShipment);
						break;
			...
			case 3:
				...
				switch (action_choice) {
					...
					case 1:
						ModifyTableContent("XML_Suppliers.xml", "SupplierID", id, ModifySupplier);
						break;

					case 2:
						ModifyTableContent("XML_Products.xml", "ProductID", id, ModifyProduct);
						break;

					case 3:
						ModifyTableContent("XML_Shipments.xml", "ShipmentID", id, ModifyShipment);
						break;
			...
			case 5:
				...
				fprintf(stdout, "To calculate the total value of all products supplied by the supplier under the number ?. { 3 }\n");
				fprintf(stdout, "For each vendor specify the number and total volume of delivery in pieces. { 4 }\n");
				fprintf(stdout, "Determine the colors of the products supplied by the supplier under the number ?. { 5 }\n\n");
